...
namespace MicroFinance.Modal
{
    class SavingsAccount
    {
        ...
        public string GenerateSavingAccID() // Savings Account IDPattern 0100220210605 (SA-SavingsAccount + 01-Region+002-BranchName/2021-CurrentYear/06-CurrentMonth/05-(CountOfCustomers+1))
        {
            int count = 1;
            string Result = "";
