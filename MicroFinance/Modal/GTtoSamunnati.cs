    ...
    class GTtoSamunnati
    {
        ...
        public List<SamuunatiReport> GetDetails(ObservableCollection<RecommendView> RecommendList)
        {
            ...
            using (SqlConnection sql = new SqlConnection(Properties.Settings.Default.db))
            {
                ...
                {
                    SamuunatiReport gs = new SamuunatiReport();
                    command.CommandText = "select Name,Dob,Mobile,Address,Pincode,AadharNumber,BankName,BankBranchName,IFSCCode,BankACHolderName,BankAccountNo,Gender from CustomerDetails where CustId='" + R.CustomerID + "'";
                    SqlDataReader reader = command.ExecuteReader();
                    while (reader.Read())
                    {
                        gs.CustomerName = reader.GetString(0);
                    ...
                    gs.PANTANno = command.ExecuteScalar().ToString();
                    command.CommandText = "select LoanApplication.RequestId,LoanApplication.LoanAmount,HimarkResult.ReportID from LoanApplication,HimarkResult where CustId='" + R.CustomerID + "' and LoanApplication.RequestId = HimarkResult.RequestID";
                    reader = command.ExecuteReader();
                    while (reader.Read())
                    {
                        gs.LoanAmount = reader.GetInt32(1);
        ...
        public void GenerateSamunnati_File(ObservableCollection<RecommendView> RecommendList)
        {
            ...
            //S.No
            var SNO = xlWorkSheet.Cells.Range["A1"];
            SNO.Value = "S.No";
            SNO.Font.Bold = true;
            SNO.Font.Size = 11;
            SNO.RowHeight = 46;
            SNO.Columns.ColumnWidth = 14;
            SNO.Borders.ColorIndex = 15;
            SNO.Cells.Interior.ColorIndex = 6;
            SNO.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;
            SNO.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
            //branch Name
            var BranchName = xlWorkSheet.Cells.Range["B1"];
            BranchName.Value = "Branch Name";
            BranchName.Font.Bold = true;
            BranchName.Font.Size = 11;
            BranchName.RowHeight = 46;
            BranchName.Columns.ColumnWidth = 30;
            BranchName.Borders.ColorIndex = 31;
            ...
            CenterName.Columns.ColumnWidth = 30;
            CenterName.Borders.ColorIndex = 31;
            CenterName.Cells.Interior.ColorIndex = 6;
            CenterName.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;
            CenterName.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;

            //Day Order
            var DayOrder = xlWorkSheet.Cells.Range["D1"];
            DayOrder.Value = "Day Order";
            DayOrder.Font.Bold = true;
            DayOrder.Font.Size = 11;
            DayOrder.RowHeight = 46;
            DayOrder.Columns.ColumnWidth = 30;
            DayOrder.Borders.ColorIndex = 31;
            DayOrder.Cells.Interior.ColorIndex = 6;
            DayOrder.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;
            DayOrder.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;

            //Day Order
            var StaffName = xlWorkSheet.Cells.Range["E1"];
            StaffName.Value = "Employee Name";
            StaffName.Font.Bold = true;
            StaffName.Font.Size = 11;
            StaffName.RowHeight = 46;
            StaffName.Columns.ColumnWidth = 30;
            StaffName.Borders.ColorIndex = 31;
            StaffName.Cells.Interior.ColorIndex = 6;
            StaffName.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;
            StaffName.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;


            //Operating Unit
            var operatingunit = xlWorkSheet.Cells.Range["F1"];
            ...
            //Customer Number
            var CusNo = xlWorkSheet.Cells.Range["G1"];
            ...
            //Report ID
            var reportid = xlWorkSheet.Cells.Range["H1"];
            ...
            //H.M Reference no
            var hmrefernce = xlWorkSheet.Cells.Range["I1"];
            ...
            //Customer Name
            var cusname = xlWorkSheet.Cells.Range["J1"];
            ...
            var Samunnatibranchmapping = xlWorkSheet.Cells.Range["K1"];
            ...
            //Customer Type
            var custype = xlWorkSheet.Cells.Range["L1"];
            ...
            //Customer Subtype
            var cussubtype = xlWorkSheet.Cells.Range["M1"];
            ...
            //Gender
            var Gender = xlWorkSheet.Cells.Range["N1"];
            Gender.Value = "Gender";
            ...
            //DOB
            var dob = xlWorkSheet.Cells.Range["O1"];
            ...
            //Business Category
            var businesscategory = xlWorkSheet.Cells.Range["P1"];
            ...
            var businessindtype = xlWorkSheet.Cells.Range["Q1"];
            ...
            //sector
            var sector = xlWorkSheet.Cells.Range["R1"];
            sector.Value = "Sector";
            ...
            //Primary Value Chain
            var primaryvaluechain = xlWorkSheet.Cells.Range["S1"];
            ...
            var secondaryvaluechain = xlWorkSheet.Cells.Range["T1"];
            ...
            //Phone NO
            var phoneno = xlWorkSheet.Cells.Range["U1"];
            ...
            //Address2
            var address2 = xlWorkSheet.Cells.Range["W1"];
            ...
            //Address3
            var address3 = xlWorkSheet.Cells.Range["X1"];
            ...
            //Address4
            var address4 = xlWorkSheet.Cells.Range["Y1"];
            ...
            //City
            var city = xlWorkSheet.Cells.Range["Z1"];
            city.Value = "City";
            city.Font.Bold = true;
            city.Font.Size = 11;
            city.RowHeight = 15;
            ...
            //Postal Code
            var postal = xlWorkSheet.Cells.Range["AA1"];
            ...
            //Email Id
            var emailid = xlWorkSheet.Cells.Range["AC1"];
            ...
            //Constitution
            var constitution = xlWorkSheet.Cells.Range["AD1"];
            ...
            //GSTIN Number
            var gstin = xlWorkSheet.Cells.Range["AE1"];
            ...
            var CusAcquisition = xlWorkSheet.Cells.Range["AI1"];
            ...
            //Bank Name
            var bankname = xlWorkSheet.Cells.Range["AJ1"];
            ...
            //Bank Branch Name
            var branchname = xlWorkSheet.Cells.Range["AK1"];
            ...
            branchname.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
            //IFSC code
            var ifsccode = xlWorkSheet.Cells.Range["AL1"];
            ...
            //Bank Account Level
            var BankAccLevel = xlWorkSheet.Cells.Range["AN1"];
            ...
            //Bank Account Number
            var BankAccNo = xlWorkSheet.Cells.Range["AO1"];
            ...
            //Sales Person Name
            var salespersonname = xlWorkSheet.Cells.Range["AP1"];
            ...
            //Loan Product
            var loanproduct = xlWorkSheet.Cells.Range["AQ1"];
            ...
            //Loan Amount
            var loanamt = xlWorkSheet.Cells.Range["AR1"];
            ...
            //Loan Tenure
            var loantenure = xlWorkSheet.Cells.Range["AS1"];
            ...
            //Loan Term Period
            var loanperiod = xlWorkSheet.Cells.Range["AT1"];
            ...
            //Loan Type
            var loanType = xlWorkSheet.Cells.Range["AU1"];
            ...
            //Loan Start Date
            var loanstartdate = xlWorkSheet.Cells.Range["AV1"];
            ...
            //Amortization Method
            var amortization = xlWorkSheet.Cells.Range["AW1"];
            ...
            var paymentstartdate = xlWorkSheet.Cells.Range["AX1"];
            ...
            var paymentfrequency = xlWorkSheet.Cells.Range["AY1"];
            ...
            //Intrest Start Date
            var intreststartdate = xlWorkSheet.Cells.Range["AZ1"];
            ...
            //Intrest Frequency
            var intrestfrequency = xlWorkSheet.Cells.Range["BA1"];
            ...
            //Loan Intrest Rate
            var loanintrestrate = xlWorkSheet.Cells.Range["BB1"];
            ...
            var processingfee = xlWorkSheet.Cells.Range["BC1"];
            ...
            //Insurance Fees 1
            var insurancefee1 = xlWorkSheet.Cells.Range["BD1"];
            ...
            var insurancefee1amt = xlWorkSheet.Cells.Range["BE1"];
            ...
            //Insurance Fees 2
            var insurancefee2 = xlWorkSheet.Cells.Range["BF1"];
            ...
            var insurancefee2amt = xlWorkSheet.Cells.Range["BG1"];
            ...
            //Penal Intrest Rate
            var penalintrestrate = xlWorkSheet.Cells.Range["BH1"];
            ...
            FillGTXL(xlWorkSheet, GetDetails(RecommendList));
            string dir = "";
            try
            {
                dir = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Report\\Samu Reports");
                if (Directory.Exists(dir))
                {
                    string FileName = dir + "\\Samu_Report_" + DateTime.Now.ToString("dd-MMM-yyyy (hh-mm)") + ".xlsx";
        ...
        public void FillGTXL(Worksheet xlWorkSheet, List<SamuunatiReport> loans)
        {
            ...
            {
                xlWorkSheet.Cells[RowStart, 1] = sno+1;
                sno++;
                xlWorkSheet.Cells[RowStart, 2] = x.BranchName;
                xlWorkSheet.Cells[RowStart, 3] = x.CenterName;
                xlWorkSheet.Cells[RowStart, 4] = x.CollectionDay;
                xlWorkSheet.Cells[RowStart, 5] = x.EmployeeName;
                xlWorkSheet.Cells[RowStart, 6] = x.OperatingUnit;
                xlWorkSheet.Cells[RowStart, 7] = x.CustomerNumber;
                xlWorkSheet.Cells[RowStart, 8] = x.ReportID;
                xlWorkSheet.Cells[RowStart, 9] = x.HMRefernceNo;
                xlWorkSheet.Cells[RowStart, 10] = x.CustomerName;
                xlWorkSheet.Cells[RowStart, 11] = x.SamunnatiBranchMapping;
                xlWorkSheet.Cells[RowStart, 12] = x.CustomerType;
                xlWorkSheet.Cells[RowStart, 13] = x.CustomerSubtype;
                xlWorkSheet.Cells[RowStart, 14] = x.Gender;
                xlWorkSheet.Cells[RowStart, 15] = x.DOB;
                xlWorkSheet.Cells[RowStart, 16] = x.BusinessCategory;
                xlWorkSheet.Cells[RowStart, 17] = x.BusinessIndustryType;
                xlWorkSheet.Cells[RowStart, 18] = x.Sector;
                xlWorkSheet.Cells[RowStart, 19] = x.PrimaryValueChain;
                xlWorkSheet.Cells[RowStart, 20] = x.SecondaryValueChain;
                xlWorkSheet.Cells[RowStart, 21] = x.Phone;
                xlWorkSheet.Cells[RowStart, 22] = x.Address1;
                xlWorkSheet.Cells[RowStart, 23] = x.Address2;
                xlWorkSheet.Cells[RowStart, 24] = x.Address3;
                xlWorkSheet.Cells[RowStart, 25] = x.Address4;
                xlWorkSheet.Cells[RowStart, 26] = x.City;
                xlWorkSheet.Cells[RowStart, 27] = x.PostalCode;
                xlWorkSheet.Cells[RowStart, 28] = x.State;
                xlWorkSheet.Cells[RowStart, 29] = x.EmailID;
                xlWorkSheet.Cells[RowStart, 30] = x.Constitution;
                xlWorkSheet.Cells[RowStart, 31] = x.GSTINno;
                xlWorkSheet.Cells[RowStart, 32] = x.PANTANno;
                xlWorkSheet.Cells[RowStart, 33] = x.AadharNo;
                xlWorkSheet.Cells[RowStart, 34] = x.ExistingRelationshipValue;
                xlWorkSheet.Cells[RowStart, 35] = x.NewCustomerAcquisition;
                xlWorkSheet.Cells[RowStart, 36] = x.BankName;
                xlWorkSheet.Cells[RowStart, 37] = x.BankBranchName;
                xlWorkSheet.Cells[RowStart, 38] = x.IFSCcode;
                xlWorkSheet.Cells[RowStart, 39] = x.BankAccName;
                xlWorkSheet.Cells[RowStart, 40] = x.BankAccLevel;
                xlWorkSheet.Cells[RowStart, 41] = x.BankAccNo;
                xlWorkSheet.Cells[RowStart, 42] = x.SalesPesonName;
                xlWorkSheet.Cells[RowStart, 43] = x.LoanProduct;
                xlWorkSheet.Cells[RowStart, 44] = x.LoanAmount;
                xlWorkSheet.Cells[RowStart, 45] = x.LoanTenure;
                xlWorkSheet.Cells[RowStart, 46] = x.LoanTermPeriod;
                xlWorkSheet.Cells[RowStart, 47] = x.LoanType;
                xlWorkSheet.Cells[RowStart, 48] = x.LoanStartDate;
                xlWorkSheet.Cells[RowStart, 49] = x.AmortizationMethod;
                xlWorkSheet.Cells[RowStart, 50] = x.PaymentStartDate;
                xlWorkSheet.Cells[RowStart, 51] = x.PaymentFrequency;
                xlWorkSheet.Cells[RowStart, 52] = x.IntrestStartDate;
                xlWorkSheet.Cells[RowStart, 53] = x.IntrestFrequency;
                xlWorkSheet.Cells[RowStart, 54] = x.LoanIntrestRate;
                xlWorkSheet.Cells[RowStart, 55] = x.ProcessingFeesPercentage;
                xlWorkSheet.Cells[RowStart, 56] = x.InsuranceFees1;
                xlWorkSheet.Cells[RowStart, 57] = x.InsuranceFees1Amt;
                xlWorkSheet.Cells[RowStart, 58] = x.InsuranceFees2;
                xlWorkSheet.Cells[RowStart, 59] = x.InsuranceFees2Amt;
                xlWorkSheet.Cells[RowStart, 60] = x.PenalIntrestRate;
                RowStart++;
            }
        }
    }
